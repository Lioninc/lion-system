    ...
    <div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-gradient-to-r from-primary to-primary-600 rounded-xl p-6 text-white">
          <h2 className="text-2xl font-bold">おはようございます、{user?.name}さん</h2>
            ...
            <div className="divide-y divide-slate-100">
              {loading ? (
                ...
                todayInterviews.map((interview) => (
                  <div key={interview.id} className="p-4 hover:bg-slate-50">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium text-slate-800">{interview.job_seeker_name}</p>
          ...
          <Card padding="none">
            <div className="p-4 border-b border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-slate-800">掘り起こしリスト</h3>
              </div>
              <Link to="/job-seekers?filter=digup" className="text-sm text-primary hover:underline flex items-center gap-1">
                すべて見る <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
            <div className="divide-y divide-slate-100">
                ...
                digUpList.map((item) => (
                  <div key={item.id} className="p-4 hover:bg-slate-50">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant={item.days_since_contact > 14 ? 'danger' : 'warning'}>
